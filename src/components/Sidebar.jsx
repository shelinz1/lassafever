  ...
  return (
    <div className="max-w-[320px] w-full h-full">
      <div className="left-0 top-auto absolute bg-white shadow ">
        ...
        <div className="w-[300px] h-[140px] mx-auto left-[18px] top-[200px] absolute bg-emerald-400 rounded-[20px] justify-center items-center gap-3 inline-flex p-5">
          <div className="justify-start items-center gap-3 flex">
            <div className="flex-col justify-center items-start gap-3 inline-flex mx-3">
